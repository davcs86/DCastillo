...
{ % Description(s) of tasks/responsibilities
	\begin{cvitems}
		\item {Collaboration in the development of an ASP.Net MVC 5 web app for calculating the daily oil \& gas distribution for PEMEX's exploration and production, with data retrieved from diverse institutional databases, including the data visualization for each point of the distribution network.}
		\begin{itemize}
...
{ % Description(s) of tasks/responsibilities
	\begin{cvitems}
		\item{Collaboration in the development of an ASP.NET MVC 4 web app for the management of industrial measurement instrumentation.}
		\begin{itemize}
		...
		\begin{itemize}
			\item{Assessment and selection of a library for drawing web-based BPM diagrams according to the following criteria: extendability, documentation (and community size \& activity for open source libraries), and the compliance with the BPMN 2.0 standard. Selecting BPMN-JS library as the best choice for the project.}
...
{ % Description(s) of tasks/responsibilities
	\begin{cvitems}
		...
		\begin{itemize}
			...
			\item {Implementation of an heuristic algorithm for the quasi-live optimization of delivery routes based on time/distance data retrieved from Google Maps API.}
